                            ...
                            <ul>
                                <li>
                                    <div className="card card-body">
                                        ...
                                        {order.isDelivered ? <MessageBox variant="success">Entregue em {order.deliveredAt}</MessageBox>
                                            : <MessageBox variant="danger">Não entregue ainda</MessageBox>}
                                    </div>
                                </li>
                                <li>
                                    <div className="card card-body">
                                        ...
                                        {order.isPaid ? <MessageBox variant="success">Pago em {order.paidAt}</MessageBox>
